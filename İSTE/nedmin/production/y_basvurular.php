...
$onerisor=$db->prepare("SELECT *  FROM yazokulu_ilerleme_kontrol where  y_ilerleme_durum=:y_ilerleme_durum");
...
if (isset($_POST['getir'])) {
  ...
  $onerisor=$db->prepare("SELECT * FROM yazokulu_ilerleme_kontrol where y_ilerleme_durum=1");
$onerisor->execute();
 
}
elseif ($_POST['odersler']==2) {
    $onerisor=$db->prepare("SELECT * FROM yazokulu_ilerleme_kontrol where y_ilerleme_durum=2");
$onerisor->execute();
}
      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
                                    ...
                                    <h2>Yaz Okulu Başvuruları <small>,</small></h2>
                                    <br><br><br>
            ...
            <td>
               ...
               <select name="odersler" class="form-control">
                            ...
                            } ?> value="1">Aktif Başvurular</option>
                            <option <?php if ($_POST['odersler']==2)  {
                              echo 'selected="selected"';
                            } ?>  value="2">Sonuçlanan Başvurular</option>
              ...
              <tbody>
                ...
                <tr>
                  <td>
                    ...
                    $kisisor->execute(array( 'id' => $onericek['y_kul_id'] )); 
                    ...
                    <td>
                     ...
                     <td>
                      <center><a href="y_basvuru_incele?basvuru_kul_id=<?php echo $onericek['y_kul_id']; ?>"><button class="btn btn-primary btn-xs">İncele</button></a></center>
                    </td>
                </tr>
                <?php  }  ?>
